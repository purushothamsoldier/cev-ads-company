  ...
  return (
    <div>
      ...
      <div className="led-products-section">
        <h2 className="section-title">Our LED Cabinet Solutions</h2>
      ...
      <div className="page-content">
        <div className="service-details">
          <h2>Custom LED Cabinet Solutions</h2>
          <p>We specialize in designing and manufacturing high-quality LED cabinets for indoor and outdoor display applications.</p>
          
          <div className="features">
            <h3>Our LED Cabinet Services Include:</h3>
            <ul>
              <li>Indoor LED Cabinets - High-resolution displays for retail and corporate</li>
              <li>Outdoor LED Cabinets - Weather-resistant for advertising</li>
              <li>Rental LED Cabinets - Quick assembly for events</li>
              <li>Custom LED Solutions - Tailored to your requirements</li>
              <li>Maintenance & Support - Professional after-sales service</li>
            </ul>
          </div>
          ...
          <div className="materials">
            ...
            <ul>
              ...
              <li>Various Pixel Pitches (P2.5 to P10)</li>
              <li>High Brightness & Contrast Ratio</li>
          ...
          <div className="contact-section">
            <h3>Get a Quote</h3>
            <p>Contact us for a free consultation and estimate for your LED cabinet project.</p>
